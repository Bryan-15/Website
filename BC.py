...
if selected == "About":
    ...
    with st.container():
        ...
        with right_column:
            ...
            st.markdown("")
            st.markdown("")
            st.subheader(":sunflower: 01/21/23 :heart:")
            st.markdown("")
            st.subheader(":sunflower: 02/18/23 :heart:")
            st.markdown("")
            st.subheader(":sunflower: 03/12/23 :heart:")
            st.markdown("")
            st.subheader(":sunflower: 03/18/23 :heart:")
            st.markdown("")
            st.subheader(":sunflower: 03/19/23 :heart:")
            st.markdown("")
            st.subheader(":sunflower: 03/21/23 :heart:")
            st.markdown("")
            st.subheader(":sunflower: 03/26/23 :heart:")
            st.markdown("")
